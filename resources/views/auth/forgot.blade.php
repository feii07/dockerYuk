                ...
                <div class="col-md-20 w-35">
                    <div class="shadow p-5 bg-white round">
                        <form method="POST" action="{{ route('forgot') }}">
                            ...
                            <p class="text-gray"> Silahkan masukkan email kamu di bawah, kami akan mengirimkan link untuk
                                mengubah password kamu. </p>
                            ...
                            <p class="text-center">Sudah ingat password? <a href="/login" class="text-blue">Coba lagi!</a>
                            </p>
                        </form>
                    </div>
                </div>
